...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0a0a0f]">
      ...
      <section 
        className="relative min-h-screen flex items-center justify-end px-8 py-24"
        style={{
          background: 'linear-gradient(to right, transparent 0%, transparent 50%, #1a0a1f 50%, #0f0a1a 100%)'
        }}
      >
        <div 
