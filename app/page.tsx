  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f]">
      ...
      <section className="relative min-h-screen flex items-center px-4 md:px-8 py-12 md:py-24 overflow-hidden">
        <div className="absolute top-0 bottom-0 left-0 w-full md:w-1/2 overflow-hidden opacity-20 md:opacity-100">
          <img 
            src="/mosaic.png" 
            alt="" 
        ...
        <div 
          className="absolute top-0 bottom-0 right-0 w-full md:w-1/2"
          style={{
            background: 'linear-gradient(135deg, #1a0a1f 0%, #0a0a0f 50%, #0f0a1a 100%)'
          }}
        />
        
        <div className="relative z-10 w-full md:w-1/2 max-w-full md:max-w-[650px] mx-auto md:ml-auto px-6 md:pl-[125px] md:pr-16 pt-12 md:pt-24" style={{ color: '#ffffff' }}>
      ...
      <section className="pt-24 md:pt-[250px] pb-24 md:pb-96 px-6 md:px-8 bg-[#0f0a1a]" style={{ color: '#ffffff' }}>
