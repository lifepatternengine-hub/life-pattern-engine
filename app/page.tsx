  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f]">
      ...
      <section className="relative min-h-screen flex items-center px-8 py-24 overflow-hidden">
        ...
        <div className="relative z-10 w-1/2 max-w-[650px] ml-auto pl-40 pr-16 pt-24" style={{ color: '#ffffff' }}>
...
>
  Start the diagnostic
      ...
      <section className="pt-[400px] pb-96 px-8 bg-[#0f0a1a]" style={{ color: '#ffffff' }}>
